...
Trait DokelioDomainsTrait {
  ...
  public static function getFormations($domain_slug=null, $page=null) {
    ...
    $query_string = "SELECT lib_domaine, accroche_domaine, url_video_domaine, code_AF, flag_avant, synth_titre, slug_domaine, slug_formation, synth_periode_de_formation, synth_formation_accroche, nom_image, image_domaine FROM formation". $where_str ." GROUP BY synth_titre ORDER BY flag_avant DESC, position_web LIMIT ". CDMA_LIMIT ." $offset";
