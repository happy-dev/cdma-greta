...
Trait DokelioDomainsTrait {
  ...
  public static function getFormations($slug=null) {
    ...
    $query_string = "SELECT DISTINCT domaine_libelle, domaine_accroche, url_video_domaine, code_AF, flag_avant, synth_titre, synth_periode_de_formation, objectif_formation, nom_image FROM formation". $where_str ." ORDER BY flag_avant DESC";
